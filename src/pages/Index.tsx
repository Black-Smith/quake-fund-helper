        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-3xl font-bold mb-6">Donate BNB to Support Earthquake Victims</h2>
                ...
                <p className="text-gray-600 mb-4">
                  Every transaction is recorded on the blockchain, providing complete transparency in how funds are collected and distributed.
                </p>
